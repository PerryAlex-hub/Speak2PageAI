...
const howitworks = () => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <h3 className="font-bold text-center items-center justify-center flex mb-24">
      ...
      <div className="flex items-center justify-center gap-4 lg:gap-24">
        ...
        <div className="flex flex-col gap-4 ">
          <p className="flex items-center justify-center "><BrainIcon size={64} strokeWidth={0.5} /></p>
